var {
  ...
  module.exports = {
    ...
    description: "Specify a Channel used for Chatting with me!",
      ...
      try {
        ...
        async function first_layer(){
          ...
          let MenuEmbed = new MessageEmbed()
            .setColor(es.color)
            .setAuthor('Ai-Chat', 'https://cdn.discordapp.com/emojis/771804364582420532.gif?size=96', 'https://discord.gg/8ABgUpT2G9')
